    ...
    <div className="flex-1 flex overflow-hidden relative h-[calc(100vh-80px)]">
      ...
      <div className="hidden lg:block w-[55%] xl:w-[60%] h-full relative bg-[#e5e3df] overflow-hidden">
        ...
        {PROPERTIES.map((prop, i) => {
          // Semi-random placement for visual effect in this mock
        ...
        <div className="absolute top-6 right-6 flex flex-col gap-2">
          <button className="bg-white p-3 rounded-full shadow-lg hover:bg-neutral-50"><span className="material-symbols-outlined">add</span></button>
          <button className="bg-white p-3 rounded-full shadow-lg hover:bg-neutral-50"><span className="material-symbols-outlined">remove</span></button>
        </div>
