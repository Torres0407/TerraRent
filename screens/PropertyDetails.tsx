        ...
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-end">
             ...
             <div className="flex gap-4">
                <button className="flex items-center gap-2 text-sm font-bold hover:underline"><span className="material-symbols-outlined">share</span>Share</button>
                <button className="flex items-center gap-2 text-sm font-bold hover:underline"><span className="material-symbols-outlined">favorite</span>Save</button>
             </div>
          </div>
          <div className="flex items-center gap-4 text-neutral-600 font-medium">
            <div className="flex items-center gap-1">
              ...
              {property.rating} · <span className="underline cursor-pointer">42 reviews</span>
            </div>
            <div className="flex items-center gap-1">
          ...
          <div className="lg:col-span-2 flex flex-col gap-12">
            <div className="flex justify-between items-center pb-8 border-b border-primary/5">
               <div className="space-y-1">
                 <h2 className="text-2xl font-bold text-primary">Whole {property.type} hosted by Sarah</h2>
                 <p className="text-text-muted">4 guests · 2 bedrooms · 2 beds · 2 baths</p>
               </div>
               <div className="size-16 rounded-full bg-sand-light border-2 border-primary/10 overflow-hidden">
                  <img src="https://picsum.photos/seed/sarah/100" className="object-cover" />
               </div>
            </div>
            ...
            <div className="sticky top-28 bg-white rounded-3xl p-8 shadow-2xl border border-primary/5 flex flex-col gap-8">
              <div className="flex justify-between items-baseline">
                ...
                <div className="flex items-center gap-1 text-sm font-bold">
                  <span className="material-symbols-outlined text-accent" style={{fontSize: '18px'}}>star</span>
                  {property.rating} · <span className="text-neutral-400 font-medium underline">42 reviews</span>
                </div>
              </div>
