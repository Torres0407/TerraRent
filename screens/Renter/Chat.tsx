        ...
        <section className="flex-1 flex flex-col relative bg-sand-light/10">
          ...
          <div className="p-8 bg-white border-t border-primary/5">
            <div className="bg-sand-light/20 border border-primary/5 rounded-[1.5rem] p-3 flex gap-3 items-center">
              ...
              />
              <button onClick={handleSend} className="size-12 bg-primary text-white rounded-xl shadow-lg hover:bg-primary-hover flex items-center justify-center transition-all"><span className="material-symbols-outlined">send</span></button>
            </div>
          </div>
        </section>
