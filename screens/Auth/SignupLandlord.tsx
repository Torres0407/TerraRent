            ...
            <form className="flex flex-col gap-5 mt-6" onSubmit={handleSubmit}>
              <div className="grid grid-cols-2 gap-4">
                <label className="relative cursor-pointer group">
                  <input className="peer sr-only" name="role" type="radio" value="landlord" defaultChecked/>
                ...
                <label className="relative cursor-pointer group">
                  <input className="peer sr-only" name="role" type="radio" value="agent"/>
                  <div className="p-4 rounded-xl border border-[#cfe7d7] dark:border-[#2a4435] bg-white dark:bg-[#162e21] peer-checked:border-accent peer-checked:bg-accent/5 dark:peer-checked:bg-[#1a3525] transition-all hover:shadow-sm flex flex-col items-center gap-2 text-center h-full">
              ...
              <div className="space-y-4">
                <input className="w-full rounded-lg border border-[#cfe7d7] dark:border-[#2a4435] bg-white dark:bg-[#162e21] px-4 py-3.5 text-primary dark:text-white outline-none focus:ring-2 focus:ring-accent/30 transition-all" placeholder="First Name" type="text" required/>
                <input className="w-full rounded-lg border border-[#cfe7d7] dark:border-[#2a4435] bg-white dark:bg-[#162e21] px-4 py-3.5 text-primary dark:text-white outline-none focus:ring-2 focus:ring-accent/30 transition-all" placeholder="Business Email" type="email" required/>
              </div>
              
              <button className="w-full bg-primary hover:bg-primary-hover text-white font-bold text-base py-4 rounded-lg shadow-lg transition-all transform active:scale-[0.98] mt-2">
                Create Account
              </button>
            </form>
          </div>
