          ...
          <div className="flex flex-col w-full max-w-md mx-auto lg:max-w-none lg:mx-0 bg-white dark:bg-white/5 backdrop-blur-sm rounded-2xl shadow-xl border border-white/40 dark:border-white/5 p-6 md:p-10">
            ...
            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative group/input">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <span className="material-symbols-outlined text-accent dark:text-gray-500 text-[20px]">person</span>
                  </div>
                  <input 
                    className="w-full pl-11 pr-4 py-3 rounded-lg border border-[#e7ddcf] dark:border-white/20 bg-sand-light/10 dark:bg-white/5 text-primary dark:text-white focus:ring-2 focus:ring-accent/50 focus:border-accent transition-all text-base" 
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative group/input">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <span className="material-symbols-outlined text-accent dark:text-gray-500 text-[20px]">mail</span>
                  </div>
                  <input 
                    className="w-full pl-11 pr-4 py-3 rounded-lg border border-[#e7ddcf] dark:border-white/20 bg-sand-light/10 dark:bg-white/5 text-primary dark:text-white focus:ring-2 focus:ring-accent/50 focus:border-accent transition-all text-base" 
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative group/input">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <span className="material-symbols-outlined text-accent dark:text-gray-500 text-[20px]">lock</span>
                  </div>
                  <input 
                    className="w-full pl-11 pr-12 py-3 rounded-lg border border-[#e7ddcf] dark:border-white/20 bg-sand-light/10 dark:bg-white/5 text-primary dark:text-white focus:ring-2 focus:ring-accent/50 focus:border-accent transition-all text-base" 
                    placeholder="••••••••" 
                    type="password" 
                    value={password} 
              ...
              <button 
                disabled={isLoading} 
                className="mt-2 w-full flex items-center justify-center gap-2 rounded-lg bg-primary hover:bg-primary-hover text-white font-bold py-3.5 transition-all shadow-md text-base group disabled:opacity-50" 
                type="submit"
              >
